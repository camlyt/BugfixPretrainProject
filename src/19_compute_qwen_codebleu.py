...
PRED_FILES = {
    "qwen_zero_shot": PREDICTIONS_DIR / "qwen_zero_shot_predictions.jsonl",
    "qwen_rag": PREDICTIONS_DIR / "qwen_rag_predictions.jsonl",
}
...
def main():
    ...
    summary_path = METRICS_DIR / "qwen_codebleu_summary.json"
